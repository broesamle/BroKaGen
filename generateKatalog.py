...
logoiconDIRabs              = os.path.abspath ( os.path.join(PATHS.rootDIR,PATHS.logoiconDIR) )
...
globalVar = {}
globalVar['iconviewbox'] = CONTSTRUCT.rubriques.readSVGContent(os.path.join(logoiconDIRabs,PATHS.iconsFN),prefix="ico-",accesKey="iconsvg")
